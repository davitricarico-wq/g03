...
CREATE TABLE IF NOT EXISTS "public"."foto" (
    ...
    "id_pet" integer,
    CONSTRAINT "foto_alvo_unico" CHECK ((("id_moradia" IS NOT NULL) <> ("id_pet" IS NOT NULL)))
);
...
CREATE INDEX "foto_id_pet_idx" ON "public"."foto" USING "btree" ("id_pet");
...
ALTER TABLE ONLY "public"."foto"
    ADD CONSTRAINT "foto_id_pet_fkey" FOREIGN KEY ("id_pet") REFERENCES "public"."pet"("id") ON DELETE CASCADE;
